# Habito — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/habito/
> 108 sections found

## 1.11a Contact point for standard documents.

Preferred: Conveyancing@habito.com
or
Hey Habito LTD
Mr A Thomson
14 Gower's Walk
...
Yes, provided a separate partner to the firm (who is not related to the seller) acts for us, there is no conflict of interest and Law Society guidelines are followed
...
Conveyancing@habito.com

## 4.1 Is there a valuation report and if so, does the lender provide it?

If a physical valuation has been carried out this will be provided with the offer pack.

## 4.3 If different from 1.11, contact point if assumptions stated by the valuer are incorrect.

If any of the information in the mortgage offer is incorrect please contact us on the contact details provided under 1.11

## 5.1.1 If different from 1.11, the contact point if the seller has owned the property for less than 6 months:

As per 1.11
Please note that the seller (or the applicant in the case of a remortgage) must have been registered as the owner of the property for at least 6 months prior to the application date.
...
All circumstances where the seller is not the owner or registered proprietor should be raised to our attention using the contact details as per 1.11
...
Yes, subject to the area of flying freehold being no more than 20% of the floor area.

## 5.7.1b Does the lender lend on freehold flats?

Generally no, but please contact us as per the contact details 1.11
...
Minimum 50 years unexpired term on lease at end of mortgage term required.
...
We do not lend on these propositions - use the contact details in 1.11 to advise us should this be the case.
...
Accepted, The minimum UK Finance requirements must be met and providing no lease agreement exists.
...
Residential properties require vacant possession to be obtained upon completion
Buy to Let properties where the property is already subject to an existing tenancy which will remain in place following completion, we will lend where the tenancy is an Assured Shorthold Tenancy and meets the following criteria:
· The tenant must be an individual
· The property must be occupied as the tenant's only or principal home
· The tenancy must be dated on or after 28/02/1997 and must not be one that can
...
NHBC
Zurich (provided the warranty is already in place, Armour Risk Management Limited must confirm that it will honour the warranty buildingguarantee@armourrisk.com).
LABC
Build Zone
Premier Guarantee
Building Life Plan
...
Yes, but the building work must be monitored or (if completed) have been monitored by a professional consultant with adequate professional indemnity insurance and the professional consultant has provided the Professional Consultant’s Certificate in the format set by UK Finance.
...
Yes - we have provided an occupiers Deed with the offer pack
...
Three working days (72 hours). You must specify the date by which you would like to receive the mortgage advance and also the actual completion date on the Certificate of Title.
...
You must hold funds no longer than 48 hours after receipt of funds. Should funds need to be returned please contact our Underwriting Team on 0330 223 0956 and return funds electronically to the Bank Account where proceeds were sent initially by Habito. Please provide the Application Number or Borrowers Surname as a reference
...
None if returned within 48 hours of completion.
...
No however a scanned copy of the mortgage deed should be submitted alongside the Certificate of Title.
...
"Executed as a deed by affixing the Common Seal of Hey Habito Limited in the presence of:
By Authority of the Board of Directors""."

## 16.3.1 Does the lender have a standard form of transfer/deed of covenant?

No. You must ensure that our interest is sufficiently protected in the transfer, including the retention of any relevant entries on the title
