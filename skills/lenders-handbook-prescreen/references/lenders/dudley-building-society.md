# Dudley Building Society — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/dudley-building-society/
> 108 sections found
...
Email: Mortgagesales@dudleybuildingsociety.co.uk
...
Only if specifically requested by us.
...
We must be notified of any cases where the seller is not represented or where you cannot satisfy yourselves with the checks carried out on the sellers representative.

## 3.1.5 What other documents are acceptable for verifying identity?

Please refer to the Dudley Building Society website for details of current, acceptable verification documents (in the Savings tab).
...
We need to be notified of any cases where the seller is not represented or where you cannot satisfy yourselves with the checks carried out on the sellers appointed representative.
...
As 1.11a. However, please use the following email address instead: MortgageCompletions@dudleybuildingsociety.co.uk

## 4.1 Is there a valuation report and if so, does the lender provide it?

An inspection of the property is not always arranged if a remortgage. If a valuation has been carried out on our behalf a copy should be obtained from the borrower. If you get a copy of the report from the borrower, we do not expect you to check the content of the report matches the information we hold. For the avoidance of doubt, regardless of where the report is obtained from, you must carry out the checks detailed in s4.2 and 4.3
...
As 1.11a. Please provide us with the following information:
1. The name and address of the person who sold, or will be selling the property to the applicant's vendor.
2. The amount paid for the property by the applicant's vendor.
3. Any connection between the original vendor and the applicant's vendor, or between either the vendor and the mortgage applicant.
4. Details of any work carried out between the two transactions.
5. Reason for remortgage.
Please place the case on hold until you receive further instructions from us.
...
As 1.11a. Please also confirm who the seller is.

## 5.4.4 Does the lender want to receive environmental or contaminated land reports?

No - simply advise us of entries in the local authority searches relating to contamination.

## 5.4.5 Does the lender accept personal searches and, if yes, what are the lender's requirements?

Yes, providing the requirements under section 5.4.7 are satisfied.
...
The conveyancer must provide us with a copy of the valid full planning permission for the proposed building, and confirm that you have submitted working drawings for Building Regulation Design Approval with either the Local Authority or an Approved Inspector.
...
No, borrower to retain. However, the solicitor should notify the Society if any issues are identified.
...
Freehold Flats are not acceptable, unless they are:
• Modern coach houses
...
Yes See 5.13 for our requirements for leasehold securities generally. We require the borrower's leasehold interest in the flat they occupy to be charged and we also require a charge over the borrower's freehold interest in the other flat subject to the lease in favour of its occupier.
...
Capital and Interest basis - 85 years at draw down
...
Please contact us, see contact details in 1.11a.
...
Yes, evidence of service is acceptable.
...
Yes, a certified copy, following completion if the mortgage deed is executed under a power of attorney.
...
The minimum CML/UK Finance requirements must be met.
...
As 1.11a, however please use the following email instead:
MortgageCompletions@dudleybuildingsociety.co.uk
...
Ark
Checkmate/Castle 10
LABC (new build and self-build)
NHBC (new build and self-build)
Premier Guarantee (new build and self-build)
Q
Protek
ICW
Self-Build Zone
Global Home Warranties Limited (new build only)
Buildzone (new build only)
...
Yes, if an appropriate Professional Consultants certificate is available.
...
Yes, providing that there is no conflict of interest in doing so.
...
Electronically - 3 clear working days
...
If completion is delayed for more than 5 working days, or will not occur at all, you must return the advance by the same method as received.
...
The advance must be returned within 5 working days of issue. If completion is delayed but will occur within 5 working days of issue we expect you to hold the monies in an interest bearing account and pass on the accrued interest to the borrower.

## 10.11 What, if any interest does the lender charge if return of the advance is delayed?

We charge interest from the same day of the advance. In the event that completion is delayed for more than 5 days or does not proceed, the advance monies must be returned to us immediately.
...
The Common Seal of Dudley Building Society was affixed in the presence of:
...
Our approval is required for a transfer of equity. Transfers of equity are dealt with by redeeming the original mortgage and a new regulated mortgage taken out.

## 16.4.1 If different from 1.11, contact point for application for consent to letting:

As 1.11a, however please use the following email instead:
Mortgages@dudleybuildingsociety.co.uk
