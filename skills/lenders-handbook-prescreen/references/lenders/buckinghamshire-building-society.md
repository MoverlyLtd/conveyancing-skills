...
If you are dealing face to face, you need to provide one item from list A (photographic) OR one item from list B and one item from list C. If the documentation is sent by post, then two items will be required, one of which must be from list A or B.
LIST A - Evidence of Identity (Government-issued document with photograph) incorporating
full name, either residential address or date of birth, such as:-
ï?? Valid signed passport
ï?? Valid photocard Driving Licence (full or provisional)
ï?? National Identity card (non-UK nationals)
ï?? Firearms Certificate or shotgun licence
ï?? Identity card issued for voters in Northern Ireland
LIST B Evidence of Identity (Government-issued document without photograph) incorporating
full name, either residential address or date of birth, such as:-
ï?? Valid old style full driving licence
ï?? Recent evidence of entitlement to a state or local authority-funded benefit, e.g. i) Pink card BR464; ii) Original notification letter from the Benefits Agency confirming the right to benefits
ï?? Inland Revenue Tax Notification (including Coding Notices/Self Assessment Statement of Account)
LIST C Evidence of address and other acceptable identity documents:
ï?? Current council tax demand letter or statement
ï?? Recent evidence of Recent Utility Bill or Certification from a supplier of utilities confirming arrangements to pay for services on pre-payment terms. We cannot accept mobile phone or internet bills
ï?? Pink card BR464 (if not used for List B), Original notification letter from the Benefits Agency confirming the right to benefits (if not used for List B)
ï?? Current Bank or Building Society passbook or recent statement containing current address
ï?? Most recent original mortgage statement from a recognised lender.
ï?? Local Council rent card or tenancy agreement
ï?? Recent Credit Card statement (Visa/Mastercard/American Express)
ï?? Recent instrument of a court appointment
...
A copy of the valuation report is sent to the solicitor with the mortgage offer. If you get a copy of the valuation report from the borrower , we do not expect you to check the content of that report matches the information we hold. For the avoidance of doubt, regardless of where the report is obtained from, you must carry out the checks detailed in S4.2 and S4.3.
...
Yes, subject to the approval of our valuer and the flying freehold not exceeding 25% of the floor area
...
Yes provided the borrower has a leasehold interest in the flat that they are to occupy. If there is no lease please refer to:
Buckinghamshire Building Society, High Street,
Chalfont St Giles, Bucks,
HP8 4QB
e-mail mortgages@bucksbs.co.uk
...
Minimum of 55 years unexpired at the end of the mortgage term
...
Yes. We will as a minimum require the right to break the lease should the society repossess the property.
...
NHBC, CRL Structural Home Warranty, LABC, Buildzone, Premier Guarantee, Building Life Plans, Build Assure, International Construction Warranties, Checkmate/Castle 10 (requires an endorsement to the Policy to cover any outbuildings). The Q Policy, Protek

## 6.7.2 What new home warranty documentation should be sent to the lender?

Confirmation of the cover only.
...
Direct to the borrower unless stated otherwise in the special conditions of the mortgage offer.
...
Yes. Our standard consent form will be sent with the mortgage offer.
...
Yes unless there is any conflict of interest.
...
Full current value of the property as given in the valuation report.
...
5 working days although requests below this will be accomodated wherever possible.

## 10.3 What are the standard deductions made from the mortgage advance?

Deductions are advised in the mortgage offer document.
...
Please return at the earliest possible opportunity.

## 10.11 What, if any interest does the lender charge if return of the advance is delayed?

Interest is charged daily at the same rate as that given in the mortgage offer.
...
As a minimum a certified copy is required.

## 14.2.1 Where should the title deeds and documents be sent?

These should be uploaded electronically to LMS STARS system:-

## 14.2.2 Which documents must I send after completion?

Where applicable the following documents should be uploaded electronically to LMS STARS system:-
Priority Notice
...
Signed as a deed by the Buckinghamshire Building Society acting by .....duly authorised by the board of directors.
...
A certified copy of the transfer is required.
...
Direct with the Land Registry by EDS1 for registered title. Please confirm title number and date of charge when sending the redemption monies.
