# Investec Bank plc — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/investec-bank-plc/
> 108 sections found

## 1.11a Contact point for standard documents.

Contact Mortgage Completions Team:
CompletionsTeam@investec.co.uk or 020 7597 5428
...
Your firm may act if a separate partner within the firm acts for us in the circumstances specified in Part 1.
...
Not unless we specifically request you to do so.
...
Please contact us on the details provided in 1.11 so we can make a decision whether or not to proceed.

## 3.1.5 What other documents are acceptable for verifying identity?

Additional List A items:
1. a valid national identity card (EEA country OR biometric/smart card type);
2. a valid UK residence permit/card; and
3. HMRC Tax Notification (most recent).
Additional List B items:
1. HMRC Tax Assessment (most recent);
2. Land Registry Report – For address;
3. Court Order / Court approved documents; and
4. Council & Housing Association tenancy agreement.
...
No, but you should notify us if any matters arise in the report that may affect our security and you should retain a copy in the file of original deal documents that you hold for the Bank.
...
We accept search insurance for remortgages and only where there is an existing mortgage on the property.
The sum insured of the policy must be an amount at least equal to the mortgage advance.
...
Accepted, subject to our prior written approval. See 1.11. Indemnity insurance may be required.

## 5.7.1b Does the lender lend on freehold flats?

Accepted, subject to our prior written approval. See 1.11.
...
Only in certain circumstances. Please refer individual cases. See 1.11
...
At least 60 years after expiry of the mortgage. If the term is less than this, please notify us (details found in section 1.11)
...
No, but you should retain a copy in the file of original deal documents that you hold for the Bank.
...
Contact details in 1.11.
You need to advise us when the purchase price is not the same as that notified to you by us.
...
Yes, where agreed and specified in the mortgage offer.
...
Buildmark Certificate
NHBC Agreement
Zurich Municipal Guarantee
Other appropriate and market acceptable warranty cover may be considered by the Bank.

## 6.7.2 What new home warranty documentation should be sent to the lender?

None. You should retain this a copy in the file of original deal documents that you hold for the Bank.

## 6.7.3 Should any assignments of building standards indemnity schemes be sent to us?

No, you should retain this in the file of original deal documents that you hold for the Bank.
...
No but you should retain this in the file of original deal documents that you hold for the Bank.
...
Usually direct to the client, but please see the offer for more details.
...
Yes. You should also provide details of any other rights in the property. These must be provided prior to completion as we may not wish to proceed.
...
We do not charge a CHAPS fee. Any other fees to be deducted from the advance will be set out in the Mortgage Offer.

## 10.7 On a delayed completion, when and how is advance to be returned?

Please notify us as soon as you become aware completion has been delayed. Refer to 1.11.
Funds should be returned electronically within one working day of completion unless otherwise agreed by us.
...
Interest will be charged at the applicable interest rate set out in the Mortgage Offer from the day funds were released until the date funds are re-credited to the Bank's account.
...
Yes, if it is an instalment mortgage or if there is a retention.

## 14.1.5 Does the lender need to be sent the original mortgage deed and/or any other original title documents?

You should retain all originals and other documents specified, in these instructions, in the file of original deal documents that you hold for the Bank. You should scan all documents and send us an indexed electronic (PDF) bible of documents.

## 14.2.1 Where should the title deeds and documents be sent?

Please send scanned PDF Copies to RetailServicing@investec.co.uk

## 14.2.2 Which documents must I send after completion?

Official copy(ies) of the Register
...
PrivateClientLegal@investec.co.uk

## 16.3.7b What form of attestation clause does the lender use?

Please refer to Part 1 B, paragraph 13 of the Standing Instructions.

## 16.3.1 Does the lender have a standard form of transfer/deed of covenant?

No, you must ensure that the Bank's interest is sufficiently protected in the transfer, including the retention of relevant entries on the title.

## 16.3.2 If different from 1.11, contact point for finding out the debt amount:

RetailServicing@investec.co.uk

## 16.3.4 Does the lender need to be sent the transfer of equity?

Not unless requested by the Bank.
...
You should retain this in the file of original deal documents that you hold for the Bank.
...
Details will be specified in the Redemption Statement.

## 17.2.1b Does the lender send the discharge via a DS 1 form or direct with the Land Registry?

Direct with Land Registry for the majority of mortgages. In exceptional circumstances, we may need to use a DS1 form.
