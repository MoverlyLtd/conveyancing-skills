# Fleet Mortgages — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/fleet-mortgages/
> 108 sections found

## 1.11a Contact point for standard documents.

Fleet Mortgages Limited, 2ND Floor, Flagship House, Reading Road North, Fleet, Hampshire, GU51 4WP
www.fleetmortgages.co.uk or The Completions Team on 01252 931399 or completions@fleetmortgages.co.uk

## 1.11b Contact point if standard documents are inappropriate.

The Completions Team on 01252 931399
completions@fleetmortgages.co.uk

## 1.7 Contact point to see if the lender will lend when borrower and mortgagor are not one and the same.

Not applicable. We do not lend in these circumstances

## 1.14 May your firm act if the person dealing with the transaction or a member of his immediate family is the seller?

Your firm may act provided a separate partner to the firm (who is not related to the seller) acts for us, there is no conflict of interest and you are acting within your professional guidelines.

## 1.15 May your firm act if the person dealing with the transaction or a member of his immediate family is the borrower?

Your firm may act provided a separate partner to the firm (who is not related to the borrower) acts for us, there is no conflict of interest and you are acting within your professional guidelines.
...
No other documents are acceptable. We also expect the documents which you have obtained to be retained by you and sent to us along with the certificate of title if we request copies
...
See 1.11a. Please note, only unqualified certificates of title will be accepted, which should be submitted in final form together with copies of any deeds of guarantee and ILA certificates.

## 4.1 Is there a valuation report and if so, does the lender provide it?

The valuation report is provided. The report is for our benefit only and the borrower(s) should be made aware both of the limitations of our report and of the importance of seeking their own surveyors report.

## 4.3 If different from 1.11, contact point if assumptions stated by the valuer are incorrect.

See 1.11a and please refer to our list of Acceptable and Unacceptable Security on our website.

## 5.1.1 If different from 1.11, the contact point if the seller has owned the property for less than 6 months:

See 1.11a
Sub-sales, where the seller has owned the property for less than 6 months, and similar back to back transactions are not acceptable.
We also regard as sub-sales circumstances where the seller (which may include a vehicle controlled in whole or in part by the borrower, or where the borrower is a company or LLP, a director, shareholder or member of the borrower), for example, acquire the freehold title to the property, or any superior interest, which they then immediately (or within 6 months) sell on to the borrower by granting a lease or leases to them.
In addition, remortgages within 6 months of the original purchase are not acceptable unless the borrower is already the registered proprietor of the property.
...
Personal Searches in respect of local authority searches are acceptable provided the search firm subscribes to the Search Code, is registered with the Council of Property Search Organisations (CoPSO) and provided that an unqualified Certificate of Title is provided by the conveyancer.

## 5.4.6 Does the lender accept search insurance and, if yes, what are the lender's specific requirements?

Search insurance is only acceptable for
-remortgages or
-where the customer is purchasing the property into an SPV from their personal name(s) or where property is transferred from limited company to limited company but where none of the individuals involved are changing (being added or removed) as part of the transaction.
PLEASE NOTE- Search insurance is only acceptable in respect of local authority searches provided that our interests are fully protected and excludes transactions:
• of £1million or more;
• relating to Houses in Multiple Occupation (HMOs);
• relating to Multi-Unit Freehold Blocks (MUBs).
Please refer to 9.1 regarding indemnity insurance policy requirements.
...
See 1.11a. Please note, only unqualified certificates of title are acceptable.

## 5.7.1a Does the lender lend on flying freeholds?

Yes so long as the flying freehold is not more than 10% of the total floor area (unless it is a coach house) and appropriate indemnity insurance is in place to protect our interests.
...
Fleet only provides mortgages on a buy to let basis and so does not lend in situations where the borrower or a relative* is to occupy the mortgage property.
When lending against leasehold, Fleet will also require a charge over the freehold where the entire freehold is ultimately owned or controlled by:
• the borrower or their relative*;
• a company or other entity over which the borrower or their relative* can exercise control; or
• a combination of the above,
* where the borrower is a company or partnership, this includes a director, shareholder, guarantor or partner of the borrower or anyone related to such person.
Please refer to the mortgage offer and conditions for further details regarding these requirements.
...
a) where the repairing obligation is divided between the two units split at first floor joist level;
b) there is a remaining term on the lease of at least 85 years subject to a nominal (peppercorn) ground rent;
c) the freehold must also be charged to the lender;
d) the freehold of neither flat can be transferred without the lease also being transferred to the same owner; and
e) access including maintenance and legal arrangements relating to the property and yard are correctly established.
...
See 1.11a. We will not consent to any second charge.
...
Yes. However, your attention is drawn to 9.1 below.

## 5.14.17a Does the lender want any documentation sent to them?

No. However, please see our requirements in 5.14.17b.

## 5.14.17b Does the lender have any specific instructions about building safety?

Fire Risk Assessment:
If the mortgage property is in a block of flats, you must obtain confirmation that a current Fire Risk Assessment (FRA) is in place. We will not lend where an FRA is required but not available or out of date. You must also confirm whether the FRA identifies any recommended works assessed as presenting a ‘substantial’ or ‘intolerable’ risk, or a high likelihood of extreme harm, and if so you must report these to us together with details and timescales, including where such works may significantly impact service charges or give rise to a section 20 notice; please do not send us the FRA itself.
EWS1 Forms:
Where the building was completed on or after 1 January 2020, an EWS1 form is not required. For buildings completed before this date, where the valuation report indicates that an EWS1 form is required, this should be passed to Fleet for review.
If, during conveyancing, you become aware that the valuer’s assumptions regarding Building Safety Act 2022 remediation liabilities are incorrect, or that the property has been identified as requiring remediation, you must report this to us immediately as we will not proceed.

## 5.14.17c Does the lender have any specific instructions relating to remortgages?

Sections 5.14.17a and 5.14.17b also apply to remortgages and references to "sellers conveyancer" should be substituted for "borrower" as appropriate.

## 5.14.1 What minimum unexpired lease term does the lender accept?

85 years unexpired at the commencement of the mortgage term but the unexpired term of the lease should not be less than 50 years at the scheduled end of the mortgage period.

## 5.14.9 If different from 1.11, contact point for matters connected with the lease:

See 1.11a.
1. Where ground rent provisions cause (or, during the term of the mortgage, are likely to cause) the lease to be treated as an Assured Tenancy under the Housing Act 1988, this is no longer applicable following legislative changes introduced by the Renters’ Rights Act 2025. From 27 December 2025, any lease with a fixed term of more than 21 years cannot become an assured tenancy, regardless of ground rent amount. Accordingly, you do not need to report ground rent levels for this purpose.
2. You are still required to report any onerous ground rent provisions to us. Onerous provisions would include, but are not limited to:
a) Provisions which allow for ground rents to double after fixed periods of less than 25 years;
b) Ground rents calculated by reference to the capital value of the mortgage property from time to time (whereupon we will expect to be given full details of the method of calculating a new capital value, who bears the costs associated with the process and how any disputes are ultimately resolved);
c) Provisions allowing for fixed increases by reference to an inflation-linked index, but which are clearly above inflation expectations.
We expect any leases granted after 22 June 2022 to be regulated leases under the Leasehold Reform (Ground Rent) Act 2022 and for any lease extensions granted after that date to also comply with that Act.

## 5.14.10 If different from 1.11, contact for service charge matters:

See 1.11a
Please report to us where the service charge exceeds 1% of the property's value or £5,000, whichever is the lower. Where you are made aware that the service charge will increase significantly please advise us what the new level will be and why.
...
No. However, we expect you to have satisfied yourself that there is no outstanding ground rent or service charges.

## 5.14.13 Does the lender require a receipted copy of notice or evidence of service to be sent to you?

No. However, we expect you to confirm that notice has been served immediately upon completion.
...
If an estate rent charge is payable on a property, this will be acceptable on the basis one of the following can be satisfied: ;
a) The terms of the estate rent charge specifically exclude the provisions of section 121 of the Law of Property Act 1925; or
b) The terms of the estate rent charge include a mortgagee protection clause which states that at least 28 days’ notice must be given to any mortgagee prior to any action for non-payment or other enforcement action being taken (including the exercise of the remedies contained in section 121 of the Law of Property Act 1925) by the owner of the estate rent charge; or
c) The owner of the estate rent charge is a management company owned by the residents, who are the shareholders of a private freehold development.
If condition b) (above) is satisfied, you should also consider whether a suitable indemnity policy should be taken out to further protect our interests.
...
No, however these should be retained within your file
...
No. We will not lend unless all documents have been signed by the borrower(s). Documents signed by attorneys are unacceptable.
...
Yes. We will only accept properties where solar panels have been installed and are subject to a lease agreement that is in line with UK Finance Requirements. Should the lease not meet the UKF minimum requirements and a deed of variation cannot be entered into on or before completion to ensure the UKF minimum requirements are met we require the lease to be referred to us together with your advice on how we should proceed.
...
Please see 5.20.1 above.

## 5.20.4 Does the lender require you to disclose the details of any existing Green Deal Plan(s) on a property?

Yes. This includes details of the work carried out, the balance outstanding, the monthly payments, outstanding term, copies of any guarantees and a copy of the Energy Performance Certificate.
...
See 1.11a. Details of any discrepancies should be provided prior to submitting the unqualified certificate of title.
...
Where a tenancy agreement contains an unconditional right for the property to be converted into an HMO, you must ensure the loan is documented under an HMO product.
...
Yes. Your attention is drawn, however, to the terms of the mortgage offer.
...
• Premier Guarantee for Private Housing and Completed Housing
...
• Advantage HCI
• Protek.
• Aedis Warranties/Homeproof
• ABC+ Warranty
• Ark Group New Residential Warranty Insurance Scheme
• Build Assure
Please note that any warranty must have been issued following periodic checks of the property during the construction or conversion process, warranties issued retrospectively are not acceptable.
...
Yes, but the building work must be monitored or (if completed) have been monitored during construction by a professional consultant holding a qualification listed in section 6.7.4. The professional consultant must have provided the Professional Consultant’s Certificate in the format set out by UK Finance and our conveyancer must check it is compliant with 6.7.4 and 6.7.5. A retrospective Professional Consultant's Certificate will not be accepted.
Where the Property comprises a flat within a building, the Professional Consultants Certificate must also be available for all common parts (including the structure) of any building prior to completion of the loan.
...
Please contact us for confirmation in each case.
...
You are referred to the terms of the mortgage offer. The only persons permitted to be in occupation are those who are occupying the property in accordance with the terms of the mortgage offer and the mortgage conditions.
...
Yes, subject to the terms of our supplemental instructions.
Please refer to the terms of the mortgage offer for any specific requirements regarding independent legal advice .

## 9.1 Does the lender need to be sent the indemnity insurance policy?

No. You should ensure that any indemnity insurance policy obtained provides suitable cover to mitigate any risk to us and the Borrower and is sufficient for you to provide a clear certificate of title. Such policy must also cover our successors in title without limitation. A copy of the policy should be retained on your file.

## 9.2 What limit of indemnity insurance does the lender require?

An amount at least equal to the valuation of the property.
...
Please see the terms of the mortgage offer

## 10.7 On a delayed completion, when and how is advance to be returned?

Electronically, within 24 hours, quoting the borrowers name and account number.
...
As set out in the redemption statement.
