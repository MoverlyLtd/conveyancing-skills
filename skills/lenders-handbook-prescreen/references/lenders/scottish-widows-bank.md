# Scottish Widows Bank — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/scottish-widows-bank/
> 108 sections found
...
LEEDS
LS1 9TY
Phone:- refer to our Instructions for individual case Completion Officer's direct dial number.
Standard documents to be obtained from www.scottishwidows.co.uk/bankconveyancers
...
Yes, provided a separate partner within the firm acts on our behalf.
...
Only if we request you to do so.
...
Additional List B:
Pension/Family allowance book
Current notice of tax coding
Recognised employer ID card bearing signature, photograph and company name.
...
Yes,if less than 25% of the whole and para 5.6.2 bullet one is complied with.
...
You should continue to report any other circumstance where the balance of the purchase price is not being provided in accordance with part 1 and in doing so must wait for our written instructions prior to proceeding.
Please Email Conveyancer Support ConveyancerSupportTeam@lloydsbanking.com
...
We do not lend unless borrower obtains 100% ownership of the property.
...
We will proceed if the work is being monitored by a Professional Consultant.
...
Electronically
The advance will be sent by CHAPS.
...
Within two business days after proposed completion date by CHAPS without deduction to:-
Lloyds Bank plc
Sort Code:- 30-18-05
Account Number:- 00009152
Payee Name:- Scottish Widows Bank
Please quote reference:- client surname
...
Two business days after proposed completion date.
...
West Yorkshire
LS1 1NS
DX 11896 Lovell Park Road Leeds
...
Mortgage Customer Services Department (see 16.3.2).
...
Mortgage Customer Services Department (see 16.3.2).
You can also request a redemption statement online at https://www.scottishwidows.co.uk/secure/forms/bank/conveyancers/redemption-statement

## 17.2.1a Where do you send the discharge and repayment remittance?

By CHAPS only to Scottish Widows Bank
Bank: Lloyds Bank plc
PO BOX 72, Bailey Drive, Gillingham, Business Park, Gillingham
Sort Code: 30-18-05
Account Number: 00030372
Account Name: Scottish Widows Bank
Reference: Quote the mortgage account number and the client?s surname.
Please note that additional interest will be charged if funds received after the redemption date shown on the statement.
