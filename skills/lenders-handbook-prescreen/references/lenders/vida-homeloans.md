# Vida Homeloans — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/vida-homeloans/
> 108 sections found

## 1.11a Contact point for standard documents.

Tel: 0330 246246 or
Email: completions@vidahomeloans.co.uk
...
Vida Homeloans does not lend in these circumstances.
...
As 1.11a. We need to be notified if the seller is not represented or where you cannot satisfy yourselves with the checks carried out on the seller's appointed representative.
...
As 1.11a. Purchase transactions where the property has been sold within the last 6 months are not normally acceptable, unless:
- £for£ bridging finance (plus legitimate fees and interest charged by the lender)
- Inherited property following the death of the proprietor, forms part of the estate for inheritance with satisfactory documentation obtained.
- New-Build property being purchased from a housebuilder that acquired the property in a part-exchange transaction.
...
Yes, copy provided after completion to:
Mortgage Services,
Vida Homeloans,
Second Floor
1 Belle Vue Square
...
Yes providing the flying freehold proportion of the security affected is no more than 25% of the property and any of the requirements in paragraph 5.7.1b of Part 2 (where applicable) and paragraph 5.7.2 of Part 1 are satisfied.
...
Yes. As 1.11a, Please report the arrangements to us so that we can ensure that there is no adverse effect upon the valuation. You should also bring to our attention any interest the borrower has in any of the other flats in the building or adjacent building.
...
Please contact on a case by case basis as per 1.11
...
Yes. As 1.11a, full information regarding incentives, allowances or discounts must be disclosed on the CML Disclosure of Incentives Form.
...
Yes and please refer to the offer for special conditions to be satisfied.
...
NHBC Certificate
Premier Guarantee (provided the insurance cover offered is greater than, or equal to, the market value or insurance figure, whichever is the greater and the certificate must not contain any reservations)
Protek
Q Assure Build Limited / The Q Policy
Zurich Municipal Policy
Other new home warranty schemes may be considered on their merits, and details should be sent to the address at 1.11a. The level of cover under the warranty must be sufficient to meet the full costs of repairing any defects covered under the warranty.

## 6.7.2 What new home warranty documentation should be sent to the lender?

Yes, copy of all relevant Certificates provided before completion as 1.11a, and after completion to:
Mortgage Services,
Vida Homeloans,
Second Floor
1 Belle Vue Square
...
• The building work must be monitored or (if completed) have been monitored during construction by a professional consultant who holds one of the qualifications listed in section 6.7.4 and who has adequate professional indemnity insurance.
• A Professional Consultants Certificate (PCC) must be available upon completion. That certificate must be in the format set by UK Finance, with no modifications to the wording.
• Retrospective PCCs are not acceptable.

## 6.7.6 Does the lender need to be sent the professional consultant's certificate?

Yes. All PCCs must be filed with the property deeds after completion.
...
Vida Homeloans will not accept part retentions. All monies to be sent to the solicitor.
...
Yes. As 1.11a (on our standard form) unless the offer states otherwise.
...
Yes, copy of the indemnity insurance policy provided before completion as 1.11a, and after completion to:
Mortgage Services,
Vida Homeloans,
Second Floor
1 Belle Vue Square
...
It must be for a minimum of 110% of the purchase price or valuation, whichever is greater
...
Please refer to the Mortgage Offer and Mortgage Offer Summary.

## 10.7 On a delayed completion, when and how is advance to be returned?

If Completion does not occur within 3 Business Days, all completion monies must be returned electronically. If possible, please inform us of the revised completion date when returning the completion monies. If you have been charged a fee for the funds to be released, this amount must not be deducted from the returned completion monies and the full advance amount must be returned to us. The borrower will be responsible for all charges (including any charge imposed on Vida Homeloans by Vida Homeloan's bank) in relation to the returned funds. You must ensure that the returned funds cover all such charges such that we receive the full amount of the loan advanced when the funds are returned. Any queries please contact as 1.11a. The completion monies are to be returned to account from which they were received.

## 10.9 If different from 1.11, contact point if completion is delayed?

As 1.11 a - A bank transfer fee may be charged on all cases, please refer to the Mortgage Offer for details of other deductions.
...
Please contact us ( see 1.11a) if this is required.
