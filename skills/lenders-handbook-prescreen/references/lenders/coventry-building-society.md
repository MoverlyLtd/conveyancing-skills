# Coventry Building Society — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/coventry-building-society/
> 108 sections found
...
For purchase applications, the deposit must come from the applicant’s own funds or be a genuine, unconditional gift from a family member. Where the gift is made for a purchase by joint applicants but for the benefit of one or more (but not all) of these, this may be protected for the purpose of such benefit under a Declaration of Trust. Where this is the case, this is subject to the mortgage taking priority over any borrower or third-party rights, and provided that the gifted amount is only recoverable once the mortgage is fully repaid.
Please note we do not accept family gifted deposits on Buy to Let transactions where the Vendor is a family member
...
You must provide the documents set out in the circumstances explained in section 5.14.17b

## 5.14.17b Does the lender have any specific instructions about building safety?

This section is applicable to a building that:
(1) is at least 11 metres in height or has at least 5 storeys (whichever is reached first); and
(2) contains at least two dwellings; and
(3) is not a leaseholder-owned building (we will not lend on a leaseholder owned building i.e. a building where the freehold estate is solely owned by the tenants of the building).
It is not applicable where there are no relevant defects (as defined in the Building Safety Act) and/or a satisfactory EWS1 form is held. The Royal Institute of Chartered Surveyors guidance in respect of cladding will be used to assess the latter. An EWS1 form rating of A1, A2 or B1 is required.
Properties rated A3 or B2 will require further checks (as set out below). Please note, funds will only be released for owner-occupied properties located in England.
If the current owner does not own a qualifying lease (as defined in the Building Safety Act 2022) and/or the building does not have confirmed funding costs (via a developer or the Government) for remediation works under the Building Safety Act 2022, the lender will not provide a mortgage.
You must notify us if the property is identified as requiring remedial works under the Building Safety Act 2022. The borrower must be notified that we will only lend if satisfactory evidence is produced as follows:
- Where the developer is funding remediation: written confirmation of intention to complete the works from a developer who has signed a contract with the Government (e.g. a developer’s letter of comfort). A full list of developers who have signed the pledge can be found at List of developers who have signed building safety repairs pledge - GOV.UK.
- Where the Government is funding remediation: written confirmation from DLUHC / MHCLG confirming the property is approved for remediation funding.
The borrower must be made aware of the above requirements and you must check that those requirements have been met. Confirmation as to which remediation scheme applies must be requested together with the appropriate evidence set out above.
A Leaseholder Deed of Certificate must be provided before completion. You must check that the certificate is completed correctly, the details match the lease agreement and the appropriate evidence demonstrating qualifying leaseholder status has been enclosed.
All documentation must be retained by you on file and provided to us if so requested. We do not require sight of any of the documentation unless requested and rely on you to make the necessary checks on our behalf. In circumstances where you are not satisfied that our requirements have been met, the case cannot proceed.
You must ensure compliance with our requirements set out in this section together with the Building Safety Act 2022. You must ensure compliance with the guidance produced by the Government when the Building Safety Act 2022 came into force and any subsequent updates. It is your responsibility to ensure the most recent guidance is reviewed and that the terms outlined herewith are also complied with. Do not submit a certificate of title before you have satisfied all our requirements. We shall only
accept unqualified certificates of title
You must provide comprehensive advice to borrowers regarding their obligations, potential financial contributions for remediation works and the impact this may have on future purchasing/remortgaging of the property. The borrower should be advised to contact us or their mortgage adviser if they have any concerns about the affordability of potential remediation costs. Evidence of that advice and confirmation from the borrower that they have received and understood the advice must be kept on your file.
Timely reporting of any issues is crucial. An EWS1 is not required for buildings constructed after 1 January 2020 but you must ensure all planning and building regulation approvals are in place. The lender does not anticipate remediation will be required but must be notified if that is not the case.

## 5.14.17c Does the lender have any specific instructions relating to remortgages?

Please refer to section 5.14.17b
...
Ground rent and other fees referred to within the Lease must be reasonable at all times during the Lease term. Ground rent increases linked to RPI or similar indexes are generally acceptable but unreasonable multipliers of ground rent are not acceptable. If you are in doubt you should refer to us and we shall refer this to our valuer.
...
First instalment to Society's Solicitor. Subsequent releases to the borrower.
...
Existing Lending & Insurance, P.O. Box 600. Oakfield House, Binley Business Park, Coventry CV3 9YR
