...
No but you'll need to let us know if you can't verify them.
...
You don't need to tell us. You mustn't accept any undertaking, for example to discharge an existing mortgage, from an unqualified conveyancer.
Otherwise, you must comply with any guidance issued by your professional body and be satisfied that there is no breach of Section 22 of the Solicitors Act 1974.
...
No but you'll need to let us know if you cant verify them.
...
By email to cots@virginmoney.com

## 4.1 Is there a valuation report and if so, does the lender provide it?

Yes, we’ll email a copy to you. It mustn’t be passed to the borrower as its obtained for our purposes only.
If you don’t receive it, call us on 0845 604 4858
...
Yes, but the conveyancer does so at their own risk.
...
We will lend where the flying freehold part is less than 15% of the total floor area of the property.
...
We're happy to lend so long as all the titles owned/to be owned by the borrower are charged to us.
...
Yes, so long as both interests owned/to be owned by the borrower are charged to us.

## 5.9.1 Does the lender lend on commonhold?

Yes, so long as the Commonhold Association has been formed in the correct manner and that our interest is adequately protected.
...
If the property is a new build, you must ensure all planning and building regulations approval are in place as required by the Act and elsewhere in this Handbook. We do not anticipate that these types of building will require remediation work under the Act. You must inform us if that is not the case.
...
Yes, but only if it's not possible or practicable to obtain a deed of variation.
...
The documents we need post-completion are listed in our current Deeds Schedule.
...
We lend on shared ownership properties in limited circumstances.
Where we know the property is shared ownership and are happy with that arrangement, we'll include a shared ownership special condition in the "Special conditions" section of our offer.
If there is no shared ownership special condition, then you need to let us know if the property is shared ownership by contacting us on:
Mortgage Processing
Operations
Virgin Money
Gosforth
...
We need you to confirm in writing that the lease contains a valid mortgagee break right, which we can exercise if we take possession of the property. Send this confirmation to:
Mortgage Processing
Operations
Virgin Money
Gosforth
...
Only if the credit agreement is for £10,000 or more.
...
• HomeProof (Aedis Group)
• Advantage HCI
• Build assure - FMB
• Building Life Plans (BLP)
• Thomas Miller Specialty Construction (TMSC)
• Build Zone (including Self-Build Zone)
• Castle 10/Checkmate (Lockton)
• Global Home Warranties
• ICW
• Local Authority Building Control New Home Warranty (MD Insurance Ltd)
• NHBC
• Premier Guarantee
• Protek
• Q-assured
...
Yes, if the if the following criteria are met:
• the property is a one-off house or a flat in a converted house, we won’t lend if the property is part of a new build estate or a new build block of flats; and
• a Professional Consultant’s Certificate must be available upon completion. That certificate must meet the requirements set out alongside this Handbook on the UK Finance’s website.
The supervision and the inspections required by the Professional Consultant Certificate must not be done retrospectively. We will not accept a Professional Consultant Certificate issued by a new home warranty provider unless that new home warranty provider is on our approve list contained in section 6.7.1 [6.6.1] of this Handbook.
...
If there is a firm intention to adopt and the development is subject to NHBC, we're happy to lend and there is no need for you to let us know.
Otherwise send details to:
Mortgage Processing
Operations
Virgin Money
Gosforth
...
Yes, our standard Letter of Consent and Postponement must be signed by the occupier. The letter must be sent direct to the occupier. Please, don't send it to the borrower.
...
We require the full market value of the Property. Where this isn't available, we'll accept the loan amount as a minimum.
...
No later than 5pm on the working day before completion.
...
You can hold funds for up to 5 working days after the completion date specified in your certificate of title. If completion has not taken place by then, funds must be returned to us.

## 10.11 What, if any interest does the lender charge if return of the advance is delayed?

If completion is delayed and you tell us, we won’t charge interest until completion, where you are holding funds in accordance with clause 10.10.
If you continue to hold funds beyond the time specified in clause 10.10, we will charge interest at that point.
Interest is charged at the rate applicable to the loan.
...
Our current Deeds Schedule confirms where documents should be sent.
...
NE3 4PL
Solicitor Helpline: 0345 604 4858
Before we send them to you, we'll released need your written undertaking to hold the deeds to our order and to return them to us within 5 working days of written request.
...
Direct with Land Registry for the majority of mortgages. In exceptional circumstances, we may need to use a DS1.
