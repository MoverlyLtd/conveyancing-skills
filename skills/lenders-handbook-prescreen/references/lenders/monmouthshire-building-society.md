# Monmouthshire Building Society — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/monmouthshire-building-society/
> 108 sections found
...
You will need to notify us using the details in 1.7 in the event of the seller not having legal representation or representation of an independent nature
...
We do not require notification unless the name and address of the solicitors firm or licensed conveyancers practice do not appear in a legal directory or they are not currently on record with the Solicitors Regulation Authority, Council for Licensed Conveyancers or other legal regulatory body as practicing at the address they have provided to you.
...
E-mail - sols@monbs.com

## 4.1 Is there a valuation report and if so, does the lender provide it?

Yes, There is always a physical inspection of the property and this yes, this will normally form part of your instructions and will be referred to in your instructions. The mortgage valuation is for our use only, therefore borrower’s should not rely upon it when deciding to purchase a property
...
Newport
NP20 1PX
For remortgage applications, the customer must have owned the property for at least 6 months. Sub-sales; where the seller has owned the property for less than 6 months, and back to back transactions are not acceptable.
...
Only in cases where further enquires are recommended in the report or where the valuer asks in his vaulation report for enquiries to be made or the Local Land Charge Search result indicates that the land is listed in the contaminated land register.

## 5.4.5 Does the lender accept personal searches and, if yes, what are the lender's requirements?

Personal searches must satisfy the requirements of paragraphs 5.4.7 and 5.4.8.
Contact:
Lending Operations Department
Monmouthshire Building Society
Monmouthshire House
...
No, please pass to the borrower for safe keeping
...
Yes but each case to be considered individually. Refer to Lending Operations Department
...
Yes but you must report the arrangements to us so that we can ensure that there are no adverse effects on valuation.
...
We require a letter from the PV Panel Provider as per the CML/BSA template letter March 2013 edition.

## 5.20.4 Does the lender require you to disclose the details of any existing Green Deal Plan(s) on a property?

Contact Lending Operations Department.
sols@monbs.com
...
Yes and provide information on CML Disclosure of Incentives Form.
...
Premier Guarantee,
Proteck
Architect Supervised, Professional Consultants Scheme
Build Zone 10 year warranty
Castle 10 (where outbuildings such as detached garage are also being constructed an endorsement to include these in cover is required).
Build Assure (New Home Structural Defects Insurance).
CRL – 10 Year Structural Defects Insurance Policy for Residential Property,
International Construction Warranties (ICW),
The Q Policy,
Aedis Warranties Ltd Homeproof New Build 10 Residential Warranty and Homeproof New Build 10 Residential Warranty for Self-Build.
One Guarantee
Ark Residential New Build Latent Defects Insurance.
Building Life Plans (BLP - excludes self builds under construction)
...
Yes but the building work must be monitored or (if completed) have been monitored by a professional consultant and the professional consultant has provided the Professional Consultant's Certificate in the CML Form.
...
iii the Developer does not have a full quote on the London Stock Exchange or is not a wholly-owned subsidiary of such a company.
...
Borrower unless otherwise instructed.
...
Yes - please send the orginal to:
...
The higher of the purchase price or valuation. For remortgages, the value of the advance.
...
Refer to Offer of Mortgage/Solicitors Instructions.

## 10.7 On a delayed completion, when and how is advance to be returned?

You must return the funds within three working days of funds release if completion is delayed:
Details are:
HSBC
Sort Code: 40-05-30
Account Number:14576608
You will be liable for accrued interest from the date of transfer of funds if funds are not returned as per the above timescale.
...
Daily interest at rate in the mortgage offer from date of issue.
...
No, following registration please electronically upload the following to LMS STARS system:-
Priority Notice
Confirmation of Application to Register
Official Copy of Register Entries
Executed Mortgage Deed

## 14.2.1 Where should the title deeds and documents be sent?

Title documents should be uploaded to the STARS LMS system.

## 14.2.2 Which documents must I send after completion?

Occupiers Consent Forms (if applicable) and insurance indemnity policies that have been requested elsewhere in Part 2 of this Handbook. Other documents should be sent to the borrowers.
...
Redemption statements can be requested using our online form which is available on our website at:
https://www.monbs.com/redemption-statement-request-form/
Redemptionsupport@monbs.com
Redemption Statement will be sent to you via 2nd class post by default. If you want to receive the statement via encrypted email, please call our Mortgage Servicing team on the number mentioned below.
