# Foundation Home Loans — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/foundation-home-loans/
> 108 sections found

## 1.11a Contact point for standard documents.

New Business Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, RG12 1WA
Email: foundation@foundationlending.co.uk
Tel: 01344 770 8033

## 1.11b Contact point if standard documents are inappropriate.

WITNESSING OF DOCUMENTS
1. We require a third party to be present and to witness the signing of our documents.
2. We will not accept witnessing of documents via video conferencing service.
INDEPENDENT LEGAL ADVICE DELIVERED BY VIDEO CONFERENCING
Please see our Distance Independent Legal Advice Certificate which can be obtained at:
https://www.foundationlending.co.uk/intermediaries/documents/document-library-buy-to-let/
...
Your firm may act if a separate fee earner of no less standing or separate partner of the firm acts for us , there is no conflict of interest and you are compliant with your professional rules and guidelines.
...
No but we expect you to have satisfied yourself as to the identity of the seller's conveyancer.
You should advise use if you intend to act on behalf of both the seller and the purchaser.
...
See 1.11a. This scenario is unacceptable to us.

## 3.1.5 What other documents are acceptable for verifying identity?

Documents additional to List A: EU Member State National Identity Card; Foreign National ID card on basis that indefinite leave to remain has been granted or Identity Card issued by Electoral Office for Northern Ireland.
Documents additional to List B:
Valid old style full UK driving licence; and/or Recent evidence of entitlement to a state or local authority funded benefit, tax credit or pension; Bank Statement or Credit Card Statement from a regulated UK firm (Internet copies are not acceptable).
...
No but we expect you to have satisfied yourself as to the identity of the seller's conveyancer.
You should advise us if you intend to act on behalf of both the seller and the purchaser.
...
See 1.11a. This scenario is unacceptable to Foundation.
...
The Certificate of Title should be submitted electronically via the solicitor panel management portal.
...
If we have not carried out a physical inspection we will not share a copy of the valuation report
Any valuation report obtained will be for our use and benefit only and cannot be relied upon by the borrower and you should make them aware of the limitations of the report and the importance of obtaining their own survey report of the property before proceeding with any transaction.

## 4.3 If different from 1.11, contact point if assumptions stated by the valuer are incorrect.

See 1.11.a
Please provide full details of any incorrect assumptions.

## 5.1.1 If different from 1.11, the contact point if the seller has owned the property for less than 6 months:

See 1.11a
For re-mortgage applications the borrower must have owned the property for at least 6 months from the original purchase date. Please note:
- Properties which have been purchased by the borrower with the aid of a bridging loan and the remortgage is to replace this loan; or
- Where the property has been purchased using cash funds and you are able to clearly evidence the origins of those funds to us;
- Where you are able to demonstrate that the borrower inherited the property following the death of the previous owner and provided you confirm this to us in writing ;
the above requirement may not apply. Please check with us before proceeding.
...
We also regard as sub-sales cases where the seller acquires the freehold title (or superior leasehold) to the property, which they then immediately sell onto to the borrower by the grant of a lease to them (or sub-lease). You should also report any other structure to the transaction which has a similar effect. This also includes circumstances where the seller is limited liability company or limited liability partnership where the borrower is a director or shareholder of the limited liability company or a member of the limited liability partnership.
Applications which involve assignable contracts, transferable contracts, novation contracts and the like or irrevocable powers of attorney in favour of intervening sellers are not acceptable. You should report any other structure to the transaction which has a similar effect.
...
All other circumstances where the seller is not the owner or registered proprietor, other than those listed in Part 1 under paragraph 5.2.1, should be referred to us providing full details.
...
Yes, subject to the requirements set out in Part 1 and provided you give an unqualified Certificate of Title. You must ensure that the search agent subscribes to the Search Code maintained by the Council of Property Search Organisations and monitored by the Property Codes Compliance Board.
...
• Multi unit properties on one title (MPOTs)
...
See 1.11a - Provide full details and your recommendations.
HMO's and Multi Units must have all requisite consents and licences. Where alterations have been carried out in excess of 10 years ago and the valuation report does not highlight any major concerns, we may consider indemnity insurance on a case by case basis.

## 5.5.3b Does the lender require an original/copy of the planning permission?

No. We may however ask you for copies of the documents if we require them, please retain copies o your file.

## 5.5.3c Does the lender require an original/copy of the building regulation consents?

No. We may however ask you for copies of the documents if we require the, please retain copies on you file.

## 5.5.3d Does the lender require certificates of lawful use or development/established use certificate?

No -We may however ask you for copies of the documents if we require them, please retain copies on your file.
...
See 1.11a
Provide full details and your recommendations. We may consider Indemnity insurance on a case by case basis.

## 5.7.1a Does the lender lend on flying freeholds?

Yes, if only part of the title is "flying" or "creeping" freehold, and you are satisfied that the arrangements made in respect of it render the title good and marketable. Indemnity insurance may be considered on a case by case basis.
Where the flying freehold is over 20% of the total floor area, these should be referred to us.
See 1.11.a

## 5.7.1b Does the lender lend on freehold flats?

No, except for South Tyneside flats where there are mutually enforceable covenants for support and maintenance of the common parts (where the applicant owns one of two units in the block under a freehold title, subject to the other flat being leasehold).
...
See 1.11.a - Provide full details of any restrictions.
...
We do not require you to report a gifted deposit where you are satisfied that the following conditions are met: The gift is from an immediate family member(s), who confirms it is not repayable.
...
We do not require copies of any documentation before completion other than that listed in 14.2.2, although you should retain copies on your file.

## 5.14.17b Does the lender have any specific instructions about building safety?

You must tell us as soon as you become aware if the current owner of the property is a non - qualifying leaseholder and confirm the known and/ or anticipated costs which may be payable by leaseholders for remediation works.
...
Section 5.14.17b also applies to remortgages.

## 5.14.1 What minimum unexpired lease term does the lender accept?

New Build houses which must have an unexpired lease term of at least 250 years at the start of the mortgage.
New Build flats which must have an unexpired lease term of at least 125 years at the start of the mortgage.
For non-new build properties, a minimum of of 50 years must remain at the end of the mortgage term.

## 5.14.9 If different from 1.11, contact point for matters connected with the lease:

See 1.11.a
Acceptable:
• Increases linked to Retail/ Consumer Price Index (or similar indices)
• Doubling (or an acceptable monetary increase) of any ground rent over periods of 20 years or more, providing the current figure is believed to be reasonable. These should be referred to FHL for individual consideration.
Unacceptable:
• Unreasonable multipliers of ground rent or other provisions;
• Doubling of ground rent over short periods, less than 20 years (e.g. 5, 10, 15 years);
• Increases linked to the value of the property;
• Fixed increases clearly above inflation expectation.
Starting ground rent must not exceed 0.1% of the market value of the security property. However, we may accept ground rent up to 0.2% market value but these must be referred to us for individual consideration.
...
(ii) a suitable indemnity policy (which complies with our requirements as set out in Part 1 paragraph 9 (Indemnity Insurance) is put in place to protect us.

## 5.14.10 If different from 1.11, contact for service charge matters:

See 1.11.a
Where you are made aware that the service charge will increase significantly (i.e. by greater than £1000 p/a), please advise us what the new level will be and why.
...
c) The cost of works and the contribution required from the borrower
...
No but you should satisfy yourself that there are no outstanding Ground Rent or service charges as at the date of completion.

## 5.14.13 Does the lender require a receipted copy of notice or evidence of service to be sent to you?

Yes - this should be sent to us after completion with the title documents.
...
No - this should be retained by the borrower but you should keep a copy on your file.

## 5.15.2c Does the lender need to be sent the signed blank stock transfer form?

A copy should be sent to us only and the original should be retained on your file.
...
No, but you should retain on your file.
...
Yes. Please also ensure that we have an unconditional right to break the lease in the event of possession and that the costs of removing the solar PV panels and making good any damage are expressly the responsibility of the solar PV provider.
...
Yes. Please send us the UK Finance Disclosure of Incentives Form - fully completed as soon as possible .
Where the property is not a new build being sold by the developer, you must notify us if the deposit (or any part of it) is to be paid by the seller.
...
See 1.11.a
Residential Properties: We require vacant possession to be obtained on completion. If this cannot be achieved you must advise us.
Buy To Let Properties: please refer to Part 1 paragraph 6.6.1 & 6.6.2 for our requirements where a property is already let or is to be let on or following completion.

## 6.6.1 If different from 1.11, contact point if property is let/to be let and to check you lend on buy-to-let:

The mortgage offer will indicate whether the mortgage is a Residential or Buy to Let product. Any queries regarding standard or special mortgage conditions should be referred to us se 1.11.a
...
The property must be let under an approved AST at or within 3 months of completion. The Mortgage Offer will set out our specific requirements for any letting of the property. Any queries regarding standard or special mortgage conditions for letting the property should be referred to us, see 1.11.a.

## 6.6.3 Does the lender require counterpart/certified copy tenancy agreement to be sent to you?

No, but a copy should be retained on your file.
...
Please refer to your instructions in the mortgage offer. Each condition and/or requirement must be satisfied prior to submission of the Certificate of Title
...
Architects Certificate (RIBA), with appropriate current professional Indemnity insurance.
Ark Insurance
Build Assure
Building Life Plans - you must request and receive confirmation from BLP that the sum insured is adequate when compared to the rebuilding costs. The certificate must not contain any reservations.
Build Zone
CADIS/CADIS MGA
Castle 10
Schemes underwritten by Casualty General Insurance Company Europe (CGICE)
Chartered Building Surveyors Certificate, or Architect's Certificate (RICS/RIBA) with appropriate current professional indemnity insurance.
Checkmate
...
NHBC
One Guarantee
Premier Guarantee, but the certificate must not contain any reservations
Protek - New Home, Custom Build, Self-Build and Completed Housing
Q Build Assure
Schemes underwritten by Elite Insurance but administered by other providers.
Zurich Municipal
All other warranty schemes must be referred to us, see 1.11a.
The level of cover under the warranty must be sufficient to meet the full costs of repairing any defects covered under the warranty.

## 6.7.2 What new home warranty documentation should be sent to the lender?

None. Please forward appropriate documentation to the borrower and retain a copy on your file.

## 6.7.3 Should any assignments of building standards indemnity schemes be sent to us?

No. Please forward appropriate documentation to the borrower and retain a copy on your file.

## 6.7.4 Will the lender proceed if the property does not have the benefit of a new home warranty scheme?

Yes, but the building work must be monitored or (if completed) have been monitored during construction by a professional consultant holding a qualification listed in section 6.7.4. The professional consultant must have provided the Professional Consultant’s Certificate in the format set out by UK Finance and it must be compliant with 6.7.4 and 6.7.5.
A retrospective Professional Consultant's Certificate is not acceptable.
Where the Property comprises a flat within a building, the Professional Consultants Certificate must also cover all common parts (including the structure) of the building and must be available prior to completion of the loan.

## 6.7.6 Does the lender need to be sent the professional consultant's certificate?

Yes - a copy is required to be sent to us and you must retain a copy on your file. The borrower is to retain the original.
...
See 1.11.a
You must also check that the servient and dominant tenements have not at any point come into common ownership so as to extinguish the easement regardless of whether the easement is still noted against the registered title.

## 6.10.2 Who will the lender release any retentions (or instalments of the advance) to?

After completion retentions will be released to the borrower.
...
Yes, our deed of consent form must be completed by all occupants aged 17 or over or anyone who may have a financial interest in the property.
...
No. You should ensure that the policy is sufficient to allow you to certify that the title to the property is good and marketable. The policy should be retained by the borrower and you should retain a copy on your file.

## 9.2 What limit of indemnity insurance does the lender require?

An amount equal to 110% of the valuation or purchase price - whichever is the greater.

## 10.2a Will the mortgage advance be paid electronically or by cheque?

Electronically. A CHAPS payment fee of £35.00 will be deducted from the advance.

## 10.2b What is the minimum number of days notice lenders require?

5 working days unless otherwise advised.

## 10.3 What are the standard deductions made from the mortgage advance?

Please refer to the offer for details of any deductions.

## 10.7 On a delayed completion, when and how is advance to be returned?

The advance should be returned immediately to the account from which it came.

## 10.9 If different from 1.11, contact point if completion is delayed?

New Business Department, Foundation, e Arlington Square, Downshire Way, Bracknell, RG12 1WA
Email: completions@foundationlending.co.uk
Tel: 01344 770 8033.
...
We do not offer retentions or phased funds release.

## 14.1.4 Does the lender require me to make a form CH2 application?

No as we do not offer deferred interest retention of phased release.

## 14.1.5 Does the lender need to be sent the original mortgage deed and/or any other original title documents?

You should register the charge at HM Land Registry using a certified copy of the mortgage deed and retain the original on your file. If the borrower is a limited liability company or partnership then the Mortgage Deed and associated Conditions must be registered at Companies House using Form MR01 within 21 days of completion. You will need to tick the Yes Box in Part 7 of form MRO1.
We require you to retain all original deeds on your file including legal charge, TID, and where applicable the deeds of guarantee, consent to mortgage, confirmation of legal advice, incentive form, certificate of registration at Companies House, any statutory declaration, stock transfer form executed by the Borrower, Indemnity Insurance Policy.
See 14.2.2 for our requirements following registration.

## 14.2.1 Where should the title deeds and documents be sent?

By email to: customerservices@foundationlending.co.uk

## 14.2.2 Which documents must I send after completion?

Following registration of the mortgage at the Land Registry and, where appropriate, at Companies House, please:
...
Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2).
If applicable, where title documents have been released on loan and the mortgage is not being repaid, you must return all documents to us on demand or when you no longer need them. If there has been a transaction requiring an application at the Land Registry you should send us official copies of the updated title when returning all other documents.
...
Signed as a Deed by Paratus AMC Limited by its Attorneys............and………....in the presence of:

## 16.3.1 Does the lender have a standard form of transfer/deed of covenant?

No. We require you to draft an appropriate form of transfer/deed of covenant as may be necessary. You must ensure that our interest is sufficiently protected.

## 16.3.2 If different from 1.11, contact point for finding out the debt amount:

Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2). Email: customerservices@foundationledning.co.uk
Tel: 01344 770 8030
...
Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2).
Email:customerservices@foundationlending.co.uk
Tel: 01344 770 8030
...
Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2). Email:customerservices@foundationlending.co.uk
Tel: 01344 770 8030
...
Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2). Email:customerservicesreferrals@foundationlending.co.uk
Tel: 01344 770 8030
...
Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2).
Email: customerservices@foundationlendin.co.uk
Tel: 01344 770 8030
...
Contact Customer Services Department, Foundation, 3 Arlington Square, Downshire Way, Bracknell, Berkshire RG12 1WA or DX 122530 Bracknell (2) or Email:customerservices@foundationlending.co.uk
Tel: 01344 770 8030
for further details

## 17.2.1b Does the lender send the discharge via a DS 1 form or direct with the Land Registry?

Directly with the Land Registry.
