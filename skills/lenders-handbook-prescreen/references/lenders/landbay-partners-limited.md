...
Telephone 0203 926 6670
Email - Legals@landbay.co.uk
...
We will not lend if the borrower and mortgagor are not one and the same.

## 1.14 May your firm act if the person dealing with the transaction or a member of his immediate family is the seller?

Your firm may act if a separate fee earner of no less standing or a partner of the firm acts for us.
...
The Seller must have legal representation.

## 3.1.5 What other documents are acceptable for verifying identity?

This is detailed in our instructions to you. You need to ensure that you are satisfied that you have discharged your obligations for the verification and identity of the borrower/signatory and keep a certified copy of the documentation upon which you have relied within your file which we may inspect.
...
See 1.11a Legals@landbay.co.uk.

## 4.5b Where should the certificate of title be sent?

The Certificate of Title should be submitted online using the 'Satisfy conditions and submit eCoT' button on the instruction email.

## 4.1 Is there a valuation report and if so, does the lender provide it?

Where Landbay has instructed a formal valuation report for the property offered as security a copy of the Valuation Report will be provided with the formal offer of mortgage. The Mortgage Offer will state where a physical valuation has not been obtained. Where a copy of the Valuation Report has not been provided the checks required under Part 1 Section 4.2 and 4.3 should be made against the information contained in the mortgage offer. Please do not request a copy of the Valuation Report if it has not been provided to you.
...
No. Where one is required you should be satisfied that it confirms no risk to us and that it is retained for information.
We will not lend where the security property is located within a high flood risk area.

## 5.4.5 Does the lender accept personal searches and, if yes, what are the lender's requirements?

Yes, at the Conveyancers own risk and the requirements listed in Part 1 of this Handbook are met.
Criteria:
...
Search insurance is only accepted for remortgaging single self-contained properties. Search insurance must protect us adequately, the title must be good and marketable, and the certificate of title must be unqualified. All cases should be subject to due diligence.
We exclude:
...
6- Properties constructed after the date of any registered charge on the C Register of the title are not accepted.
If searches are older than 6 months at completion, we are unable to accept a search validation indemnity insurance policy. A full new suite of searches must be carried out.
...
If alterations were made more than 7 years ago for planning and more than 10 years ago for building regulations, indemnity insurance can be used if the valuation report does not highlight major concerns or negative commentary.
Houses of Multiple Occupation (HMO’s) & Multi Unit Blocks (MUB's):
A multi-unit block or HMO must have all the required consents and licenses.
Fire Risk Assessment (FRA):
It will be necessary to obtain a copy of the Fire Risk Assessment (FRA) where the security is located in a block of flats. We cannot lend where the FRA is out-of-date or absent. You should obtain evidence that the recommended works have been completed if you receive an FRA with recommendations. You should only refer back to the Completions team for review if they have not been completed.
Septic tanks:
Private drainage systems, such as septic tanks, should have adequate legal rights, adequate covenants and arrangements regarding their access, use, and enforcement of repairs, contributions, and insurance.

## 5.5.3b Does the lender require an original/copy of the planning permission?

No. Please retain the original / copy on your file.
...
Yes. These should be retained within your file.
...
Manorial Rights:
In respect of Unilateral Notices relating to Manorial Rights only, we require an Indemnity policy to be placed on risk at completion to cover 100% of the property valuation or purchase price (whichever is greater) plus 10%.
All other points see 1.11a.
...
If the property is a freehold flat, this is not applicable as we do not lend on freehold flats; in relation to 5.7.1a, see 1.11a Legals@landbay.co.uk.
...
We will not lend on a property which is occupied by the borrower, in that our loan is for a buy-to-let property. However, we will lend if the borrower has a lease of one of the flats and also owns the freehold of the building and the other flats are subject to long leases.
...
We are not able to proceed on this basis.
North Tyneside Leases:
A full legal charge is required over both the leasehold and the corresponding freehold titles. Both title numbers must be included in the Certificate of Title and the Legal Mortgage.
...
Where the security property is leasehold, the lessee must not be in breach of any covenant when letting.
Where the security property is leasehold or freehold, there must be no restriction on the use of the property for example as a single unit.
...
See 1.11, if we have not detailed it in the Mortgage Offer conditions.
...
Yes, if the title remains good and marketable and you are satisfied that such indemnity insurance covers all associated risks and you are able to issue an unqualified title certificate.

## 5.14.17a Does the lender want any documentation sent to them?

No. We may, however, ask you for copies of the documents if we require them post completion. All documents must be retained within your formal retention policy.

## 5.14.17b Does the lender have any specific instructions about building safety?

EWS (External Wall Safety Certificate) standard A1 is the only rating that Landbay accepts for buildings higher than 11m. Ratings lower than A1 will not be considered for lending.
EWS – 1 provider. May be accepted if they met the standards requirements of the professional body that supervises them at the time the certificate was issued.
...
65 years unexpired at the end of the of the mortgage term.
...
The service charge cannot exceed 1.0% of the property value for loans up to £499,999.99, and 1.5% of the property value for loans of £500,000.00 and over. You must contact us if it exceeds this amount.
Where you are advised that works are planned to the property which our applicant is liable for, please provide:
...
You should only refer back to the Completions team for review if the lease does not meet our requirements.
...
No. This should be retained in your file.
...
A power of attorney must not be used for the execution of our documents. Where other documents have been executed under a power of attorney, this should be sent to us after completion.

## 5.17.5b Does the lender need to be sent the statutory declaration of non-revocation of power of attorney?

Yes. This should be sent to us after completion.
...
N/A. We will not lend on these types of properties.
...
N/A. We do not lend on properties that are subject to PV (solar panel) leasing.
...
See 1.11a.
As part of our instructions you are required to check the position of the boundaries of the subject property with your client. The boundaries must be clearly defined by reference to a suitable plan, or property description. They must accord with the information provided in the valuation report, if this has been provided to you and you should check with the applicant that the plan or description accords with the borrowers understanding of the extent of the property to be mortgaged to us. In all cases where a copy of the valuation report has not been provided, you should check the position with the applicant that the plan or the description accords with the applicants understanding of the extent of the property to be mortgages to us. In all cases, you must report to us if there are any discrepancies for consideration by us to determine whether we are prepared to proceed with the matter.
...
Yes. Please forward to us the UK Finance Disclosure of Incentives form fully completed.
...
If the vendor is a family member, we may only lend with vacant possession.
If vacant possession isn't being offered on the property, and the tenant isn't related to our borrower, the AST must be assigned to our borrower.
...
Yes. All national regulations, local planning and licencing requirements should be complied with. Please see the details within our mortgage offer.

## 6.7.1 What new home warranty schemes are acceptable to the lender?

The acceptable schemes are listed below:
ARK
ACHI Limited/Advantage HCI Limited
BLP New Build Warranty Scheme
Build - Zone
Checkmate UK
Global Home Warranties Ltd
Home Proof Structural Warranties
...
All relevant documentation in respect of the acceptable scheme.

## 6.7.3 Should any assignments of building standards indemnity schemes be sent to us?

Yes. Place with the title deeds after completion.

## 6.7.4 Will the lender proceed if the property does not have the benefit of a new home warranty scheme?

Yes, but only if the building work is being (or was) monitored by a professional consultant and you have obtained evidence that the professional consultant has suitable current professional indemnity insurance cover.

## 6.7.6 Does the lender need to be sent the professional consultant's certificate?

Yes. This needs to be sent to us after completion.

## 6.8.1 If different from 1.11, contact point if no agreement and bond for an unadopted road or sewer:

We can only proceed if appropriate rights of way exist, the applicants are aware of their potential liability, fully enforceable maintenance rights exist and there are no current disputes.

## 6.9.1 If different from 1.11, contact point if necessary easements are absent:

See See 1.11a.
The solicitor must ensure that the property enjoys full rights (both pedestrian and vehicular) over any access (private or otherwise) leading to the property and any areas connected with its enjoyment (for example, but not limited to, car parking areas, separate garage, garden areas).
The solicitor must also ensure there are adequate covenants and arrangements in respect of the repair and maintenance of any access or services to the property and report if any such maintenance liabilities are in excess of £250 per annum in addition to any annual service charge there may be.

## 6.10.2 Who will the lender release any retentions (or instalments of the advance) to?

We will not permit completion of a case where there is a retention in place. The mortgage offer will detail any specific requirements.
...
We do not lend where there is an overage agreement in place, or where one will be created on completion.
...
We will not proceed with a case where the property is affected by an improvement/repair grant which will not be discharged on completion of our loan. If the council provides written confirmation that repayment is not required, the case can proceed on normal terms. After the grant has been repaid, the local authority must ensure that the relevant entries on the register of local land charges are removed.

## 7.3 Does the lender require a consent to mortgage from all occupants aged 17 or over?

We will only make an advance on a buy-to-let basis. Therefore, the residential status can only be as a tenant. This is clearly detailed in our mortgage offer (including the conditions).
...
The lender does not allow you to advise any guarantor. Please see our instructions to you for our requirements in relation to independent legal advice.

## 9.1 Does the lender need to be sent the indemnity insurance policy?

No. In the event that we agree to indemnity cover you should ensure that the policy is sufficient to allow you to certify that the title to the property is good and marketable.

## 9.2 What limit of indemnity insurance does the lender require?

An amount equal to 100% of the property valuation or purchase price (whichever is greater) plus 10%.
...
Note that we normally require a minimum of 5 working days’ notice upon submission of the certification of title. However, there may be extended periods of notice approaching seasonal holidays. If this is the case, we will advise you.
If the completion date needs to be brought forward, a minimum of 3 working days’ notice is required. We are unable to accommodate any changes to the completion date without this notice period.

## 10.3 What are the standard deductions made from the mortgage advance?

Please refer to the offer for details of deductions.

## 10.7 On a delayed completion, when and how is advance to be returned?

Contact Legals@landbay.co.uk immediately. Please also see our instructions to you.
...
Funds may be retained for up to 3 working days by prior approval only.
Please contact legals@landbay.co.uk on the original day of completion to obtain approval to hold the funds.

## 10.11 What, if any interest does the lender charge if return of the advance is delayed?

See the mortgage offer.
Interest is charged from the date that monies are advanced to solicitors. We will charge interest at the rate stipulated within the Mortgage Offer in the event that the advance is not returned to us in a timely manner.
...
See our instructions - you should retain these.

## 14.2.2 Which documents must I send after completion?

Scanned copies only where necessary to support title.
...
We currently do not permit transfers of equity.
...
Customer Services Department, Landbay Partners Limited PO Box 1090 Ipswich IP1 9DW (Telephone 03300 536825).
