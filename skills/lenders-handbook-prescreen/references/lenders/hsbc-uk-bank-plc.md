# HSBC UK Bank plc — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/hsbc-uk-bank-plc/
> 108 sections found
...
a) any occupants aged 17 years or over at the date of completion (including lodgers);
...
It is your responsibility to obtain a redemption figure for the existing mortgage and you must be satisfied that there are sufficient funds available for this to be re-paid. On receipt of the Certificate of Title, we will send you the funds which you must use to repay the existing mortgage. Where the existing mortgage is with HSBC UK Bank Plc, you must return the funds to us, we will then arrange to close the existing mortgage and release our current charge by eDS1. You must register the new mortgage deed.
