# Intelligent Finance — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/intelligent-finance/
> 108 sections found
...
List A
- employer?s identity card with the signatory?s photograph and signature (provided you know the employer).
List B
- employer?s identity card with signatory?s photograph and signature (if you do not know the employer)
- current UK driving licence (full old paper version)
- Self-employed in the Construction Industry - tax exemption certificate with photograph of the holder (issued by the Inland Revenue, forms CIS4, CIS5 or CIS6)
- Benefits Agency Benefit book or original notification letter from the Benefits Agency confirming right to benefits
...
Please supply a copy on completion of registration to Incoming Deeds, Deeds Customer Services, Halifax plc, Trinity Road, Halifax, West Yorkshire HX1 2RG (DX11896 Halifax) and forward the original to the borrower.
...
No. Please note we will not allow an attorney to operate the mortgage following completion.

## 5.17.5b Does the lender need to be sent the statutory declaration of non-revocation of power of attorney?

No, please note that we will not allow an attorney to operate the mortgage following completion.
...
Please refer to Securities, Intelligent Finance, PO Box 890, Leeds, LS1 9UG
...
An amount at least equal to the total of the initial mortgage advance plus any pre-agreed reserve. These amounts will be shown in the mortgage offer.
...
Within 7 days, by CHAPS to Sort Code 11-91-20 Account no. 00000000 quoting the borrower's surname and initials and the Intelligent Finance plan number and jar name.
...
Incoming Deeds, Deeds Customer Services, Trinity Road, Halifax HX1 2RG (DX11896 Halifax). Please quote the Intelligent Finance plan number.
...
Our schedule
Originals (where applicable): personal guarantee (our form L4(EW)(IF)); consent to mortgage.
Copies (where applicable): official copy entries (please write the Intelligent Finance plan number on these); licence to assign; receipted notice of mortgage served on landlord or evidence of service; memorandum and articles of association of management company; section 442 agreement.
DO NOT SEND US ANY OTHER DOCUMENTS (N.B. WE DO NOT NEED THE LEASE WHERE THE TITLE IS LEASEHOLD). PLEASE FORWARD THESE TO THE BORROWER.
Where you request the title documents on loan and the mortgage is not being repaid, you must return all the title documents to us when you no longer need them. The only exception to this is where there has been a transaction involving an application for registration, since a charge certificate will no longer be issued. In those circumstances, as well as returning all the other title documents we sent you, you should send us official copy entries of the title (please write the Intelligent Finance plan number on these) in place of the charge certificate.
...
Deed of covenant - Yes, L1(EW)(IF), request from Securities, Intelligent Finance, PO Box 890, Leeds, LS1 9UG
...
Intelligent Finance (IF) 11-91-20 mortgage account number being repaid
