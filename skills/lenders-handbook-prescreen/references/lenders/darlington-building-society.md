# Darlington Building Society — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/darlington-building-society/
> 108 sections found
...
No - The Society does not need notification of the name and address of the Seller's conveyancer but we expect you to have satisfied yourself as to the identity of the seller's conveyancer. If you are aware that there is an conflict of interest or where the same firm is acting for the seller please advise the Society in writing.
...
Mortgage Processing Team Principal Office
...
As 1.11. Purchase transactions where the property has been sold within the last 6 months are not normally acceptable, unless the property is being purchased from a house builder that acquired the property in a part exchange transitions.
Remortgages (where the customer is already the registered proprietor of the property whether subject to an existing mortgage or not) within the first 6 months of the original purchase date are not normally acceptable, unless:
-you are able to provide evidence that the customer inherited the property following death of the previous owner
-the remortgage is to replace bridging finance. Remortgages out of bridging finance and/or a cash purchase cannot involve capital raising unless this relates to refurbishment costs.
...
Applications which involve assignable contracts or irrevocable powers of attorney in favour of intervening sellers are not acceptable. You should also report any other structure to the transaction which has a similar affect.
...
Yes, for remortgages only. Search firm must subscribe to the Search Code, monitored by the PCCB.

## 5.4.6 Does the lender accept search insurance and, if yes, what are the lender's specific requirements?

Yes, for remortgages only. The minimum amount of cover must be the open market value of the property, and you are satisfied that you are able to certify that the Title is good and marketable.
...
No but refer to Customer Support Department, Principal Office if you feel the security is adequate.
...
Yes, but refer individual cases prior to submitting Certificate of Title
...
• Ground rent must be reasonable and not exceed 0.1% of the market value of the property when taken as security.
...
Please send copy with Certificate of Title
...
Commercial Lending Department, Principal Office
...
The installer must be certified by the Microgeneration Certification Scheme, a copy certificate should be provided.
We require sight of all planning permissions and structural surveys.

## 5.20.4 Does the lender require you to disclose the details of any existing Green Deal Plan(s) on a property?

Yes; if possible provide a copy of the Energy Performance Certificate (EPC) showing the 22 digit reference number for the Green Deal provider. If this is not available provide full details (name & address) of Green Deal provider
...
Yes-Please report all incentives, allowances or discounts to the CUSTOMER SUPPORT DEPARTMENT, PRINCIPAL OFFICE. Please state the value of these and the purchase price paid. Such arrangements may lead to our mortgage offer being withdrawn or amended.
...
Yes, certified after completion
...
NHBC
LABC New Home Warranty Premier Guarantee
Castle 10 New Home Warranty
Build-Zone
Protek
Q Assure
AEDIS (New Build; Self Build)
Premier
ICW
One Guarantee
Advantage Home Construction Insurance
ARK Insurance Group
BLP (Build Lifeplan Ltd) (excluding self-build under construction)
ABC+
Checkmate
CADIS
...
Yes - we require a copy. The borrower to retain the original.
...
No (see 6.7.6 below) unless the development has been monitored by a Professional Consultant with acceptable level of professional indemnity insurance and has suitable qualifications. Please refer to Customer Support - Principal Office.

## 6.7.6 Does the lender need to be sent the professional consultant's certificate?

Yes, prior to exchange of contracts; any variation from this refer to a Team Leader in the Customer Support Department, Principal Office
...
Solicitor or borrower. Refer to Customer Support Department, Principal Office for clarification.
...
No. Please include Insurance Company and Policy No on Certificate of Title. Borrower is to retain the policy document.

## 9.2 What limit of indemnity insurance does the lender require?

The higher of value or purchase price of the property.

## 10.2a Will the mortgage advance be paid electronically or by cheque?

Electronically - It is your responsibility to ensure bank details on our nominated solicitor panel and the Certificate of Title are correct.

## 10.2b What is the minimum number of days notice lenders require?

5 days notice - however subject to all special conditions being satisfied we can complete with a minimum of 48 hours notice.

## 10.3 What are the standard deductions made from the mortgage advance?

None, unless the Offer document specifies otherwise

## 10.7 On a delayed completion, when and how is advance to be returned?

If delay is less than 7 days retain funds. If delay is more than 7 days funds to be returned by EFT immediately and confirmed by telephone and provide written confirmation by fax or e-mail.
...
With the exception of the TID (see 14.2.2 below) borrowers to retain.
...
"This document was executed by authority of the Board of Directors of Darlington Building Society".
...
Yes.We require the TR1 to execute prior to registration at the Land Registry. we require an updated TID on completion
...
Customer Support Department, Principal Office.
Please advise reason for redemption e.g. sale, remortgage, inheritance

## 17.2.1a Where do you send the discharge and repayment remittance?

If not sending by EFT (our preferred method)by cheque to - 8 Tubwell Row Branch, Darlington, DL1 1NX

## 17.2.1b Does the lender send the discharge via a DS 1 form or direct with the Land Registry?

Electronic-DS1 via Land Registry Direct.
