# Furness Building Society — Part 2 Requirements

> Scraped from UK Finance Lenders' Handbook on 2026-04-15
> Source: https://lendershandbook.ukfinance.org.uk/lenders-handbook/englandandwales/furness-building-society/
> 108 sections found

## 1.11a Contact point for standard documents.

Mortgage Completions Team
Emlyn Hughes House
Abbey Road
Barrow in Furness
Cumbria LA14 5PQ
...
- A valid (old style) driving licence (must be accompanied by a second document
- Grant of probate
...
A copy of the valuation report will be provided if a full valuation has been carried out. The mortgage offer will state where a full valuation report has not been obtained. The solicitor should rely on the report provided by the Society, not any report provided by the applicant and should contact the Society should a report not have been provided.
...
Yes, subject to the solicitor ensuring adequate indemnity insurance is in place. The search code monitored by the Property Codes Compliance Board only.
...
Yes if only part of the security is affacted and satisfactory legally defined rights of support exist.
...
Yes, with the title deeds, unless the offer of mortgage makes no reference to tenancies or leases, in which case copies are required prior to completion.
...
NHBC, Premier Guarantee, Buildzone, Checkmate, Protek, LABC New Home Warranty (only on individual new-build houses).
Others are subject to referral to Centralised Mortgage Processing.

## 6.7.2 What new home warranty documentation should be sent to the lender?

All certificates/warranties.
...
Usually to the solicitor, although we will consider releasing directly to borrowers subject to receiving the solicitor's written consent.
...
Property valuation or purchase price, whichever the greater.
...
Three clear working days. If a re-inspection is required, 5 working days.
...
Within one working day by CHAPS to National Westminster Bank PLC, sort code 01-00-61, account 88824837, quoting mortgage account number and customer name.

## 10.9 If different from 1.11, contact point if completion is delayed?

Mortgage Completions address shown in 1.11a
...
No, unless the Society has requested this as a separate instruction
...
Member Services at address shown in 1.11a.

## 14.2.2 Which documents must I send after completion?

Mortgage Deed, Official Copy of Register entries and lease, if applcable.

## 16.1.1 If different from 1.11, contact point for title documents:

Member Securities at address shown in 1.11a.
...
The Common Seal of Furness Building Society was hereby affixed by Order of the Board of Directors in the presence of:
...
Member Services at address shown in 1.11.
